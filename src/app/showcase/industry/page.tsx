...
const CATEGORY = SHOWCASE_CATEGORIES.find((category) => category.slug === 'industry');

if (!CATEGORY) {
  throw new Error('Industry showcase 데이터가 필요합니다.');
}

export default function IndustryShowcaseCategoryPage() {
  return (
    <main
      style={{
        maxWidth: 960,
    ...
    >
      <header style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
        <p style={{ margin: 0, color: '#888', fontWeight: 600 }}>Showcase · Industry</p>
